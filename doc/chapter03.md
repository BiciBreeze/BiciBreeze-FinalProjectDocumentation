...
| -------- | ------------ | ------------ | ------------ | 
|  US01 | Visualizacion de lista de tipos de suscripcion | Como visitante de la landing page, quiero poder visualizar rapidamente la seccion de planes para poder identificar cuales son los tipos de suscripcion que ofrece la landing page.  |  Escenario: **Dado que** quiero visualizar la seccion de planes, **cuando** ingrese a BiziBreeze **y**  le de click a la opcion de "Plans", **entonces** será redirigido hacia esa seccion **y** podrá ver todos los tipos de suscripcion disponibles. |   
| US02  |  Visualizacion de sección de Creadores |  Como visitante de la landing page, quiero ver un diseño moderno y atractivo, para sentir confianza y motivación a usar el servicio. |  Escenario:  **Dado que** el usuario está interesado en alquilar bicicletas, **cuando** ingrese al sitio web de BiziBreeze, **entonces** se mostrará información detallada en la parte inferior donde podra conocer un poco más de la empresa. |  
|  US03 | Visualización de servicios  | Como visitante de la landing page, quiero una interfaz clara y fácil de usar, para reservar una bicicleta rápidamente.  |  Escenario: **Dado que** estoy en la seccionn de servicios, **cuando** interactúe con los elementos, **entonces** el se mostrará detalladamente el servicio que ofecemos. |   
...
| US21  |  Visualizacion de beneficios| Como visitante de la landing page, quiero poder visualizar rapidamente la seccion de beneficios para poder identificar cuales son los cambios positivos en mi vida luego de usar bicicleta. |Escenario: **Dado que** que quiero empezar a usar bicicleta, **cuando** accedo a la sección de benficios, **entonces** debería ver una lista de beneficios que me trae el usar bicicleta en mi vida diaria. |
| US22  |  Visualizacion de Testimonios | Como visitante de la landing page, quiero poder ver otros testimonios de otros usuarios para ver si la empresa es confiable.  |Escenario: **Dado que** quiero visualizar la seccion de testimonios, **cuando** ingrese a BiziBreeze, **entonces** podrá visualizar la seccion de tetimonios **y** podrá ver varios testimonios de otros usuarios.|
...
| ------------ | ------------ | ------------ | ------------ | ------------ |
|  1 | US01 | Visulizacion de Planes |  Como visitante de la landing page, quiero poder visualizar rapidamente la seccion de planes para poder identificar cuales son los tipos de suscripcion que ofrece la landing page. | Alta  |
| 2  | US02 | Visualizacion de sección de Creadores |  Como visitante de la landing page, quiero ver un diseño moderno y atractivo, para sentir confianza y motivación a usar el servicio.| Alta  |
| 3  | US03 | Visualización de servicios  | Como visitante de la landing page, quiero una interfaz clara y fácil de usar, para reservar una bicicleta rápidamente.  | Alta  |
...
| 21  | US21 | Visualizacion de beneficios| Como visitante de la landing page, quiero poder visualizar rapidamente la seccion de beneficios para poder identificar cuales son los cambios positivos en mi vida luego de usar bicicleta.|Media   |
| 22  | US22 | Visualizacion de Testimonios | Como visitante de la landing page, quiero poder ver otros testimonios de otros usuarios para ver si la empresa es confiable.  |Media   |
